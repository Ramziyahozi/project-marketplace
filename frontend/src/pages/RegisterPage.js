    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-green-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-2xl w-full space-y-8 relative z-10">
        ...
        <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <h2 className="text-4xl font-bold text-white mb-4">Bergabung dengan SurplusFood</h2>
          <p className="text-gray-400 text-lg">Buat akun baru dan mulai berpartisipasi dalam mengurangi limbah makanan</p>
        </div>
        ...
        <div className={`bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 p-8 shadow-2xl transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: '200ms' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
                    <svg className={`w-5 h-5 transition-colors duration-300 ${focusedField === 'name' ? 'text-green-400' : 'text-gray-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
                    <svg className={`w-5 h-5 transition-colors duration-300 ${focusedField === 'email' ? 'text-green-400' : 'text-gray-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
                    <svg className={`w-5 h-5 transition-colors duration-300 ${focusedField === 'phone' ? 'text-green-400' : 'text-gray-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
                    <svg className={`w-5 h-5 transition-colors duration-300 ${focusedField === 'password' ? 'text-green-400' : 'text-gray-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
                    <svg className={`w-5 h-5 transition-colors duration-300 ${focusedField === 'confirmPassword' ? 'text-green-400' : 'text-gray-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-400">
              Sudah punya akun?{' '}
              <Link to="/login" className="font-semibold text-green-400 hover:text-green-300 transition-colors duration-300">
                Masuk di sini
              </Link>
            </p>
          </div>
